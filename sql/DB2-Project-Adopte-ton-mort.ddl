...
alter table COMPTABLE add constraint ID_COMPT_PERSO_FK
     foreign key (id)
     references PERSONNEL;

alter table DETAIL add constraint SID_DETAI_Conti_FK
     foreign key (id)
     references Contient;

alter table DETAIL add constraint REF_DETAI_COMMA
